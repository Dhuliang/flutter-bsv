...
void main() {
  group('TxBuilder', () {
    ...
    // TODO: NEXT
    group('#signTxIn', () {
      // test('should sign and verify no SIGHASH_FORKID synchronously',  () {
      //   // prepare
      //   var obj = prepareAndBuildTxBuilder()
      //   TxBuilder txb = obj['txb'];
      ...
      // test('should sign and verify SIGHASH_FORKID synchronously',  () {
      //   // prepare
      //   var obj = prepareAndBuildTxBuilder()
      //   TxBuilder txb = obj['txb'];
      //   var keyPair1 = obj.keyPair1
    ...
    //   test('should sign and verify synchronously with no public key inserted at input',  () {
    //      prepareTxBuilder () {
    //       var txb = new TxBuilder()

    //       // make change address
    //       var privKey = new PrivKey().fromBn(new Bn(1))
    //       var keyPair = new KeyPair().fromPrivKey(privKey)
    //       var changeaddr = new Address().fromPubKey(keyPair.pubKey)

    //       // make addresses to send from
    //       var privKey1 = new PrivKey().fromBn(new Bn(2))
    //       var keyPair1 = new KeyPair().fromPrivKey(privKey1)
    //       var addr1 = new Address().fromPubKey(keyPair1.pubKey)

    //       var privKey2 = new PrivKey().fromBn(new Bn(3))
    //       var keyPair2 = new KeyPair().fromPrivKey(privKey2)
    //       var addr2 = new Address().fromPubKey(keyPair2.pubKey)
    ...
    //       // pubKeyHash out
    //       var scriptout1 = new Script().fromString(
    ...
    //       // pubKeyHash out
    //       var scriptout2 = new Script().fromString(
    //         'OP_DUP OP_HASH160 20 0x' +
    //           addr2.hashBuf.toString('hex') +
    //           ' OP_EQUALVERIFY OP_CHECKSIG'
    //       )

    //       var txOut1 = TxOut.fromProperties(new Bn(1e8), scriptout1)
    //       var txOut2 = TxOut.fromProperties(new Bn(1e8), scriptout2)
    //       // total balance: 2e8
    ...
    //     // make change address
    //     var privKey = new PrivKey().fromBn(new Bn(100))
    //     var keyPair = new KeyPair().fromPrivKey(privKey)
    //     var changeaddr = new Address().fromPubKey(keyPair.pubKey)

    //     // make addresses to send from (and to)
    //     var privKey1 = new PrivKey().fromBn(new Bn(1))
    //     var keyPair1 = new KeyPair().fromPrivKey(privKey1)
    //     var addr1 = new Address().fromPubKey(keyPair1.pubKey)

    //     var customScript = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr1.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')

    //     var txOut1 = TxOut.fromProperties(new Bn(1e8), customScript)
    ...
    //   test('should sign and verify a lot of inputs and outputs',  () {
    //     // make change address
    //     var privKey = new PrivKey().fromBn(new Bn(100))
    //     var keyPair = new KeyPair().fromPrivKey(privKey)
    //     var changeaddr = new Address().fromPubKey(keyPair.pubKey)
    ...
    //     var privKey2 = new PrivKey().fromBn(new Bn(2))
    //     var keyPair2 = new KeyPair().fromPrivKey(privKey2)
    //     var addr2 = new Address().fromPubKey(keyPair2.pubKey)

    //     var privKey3 = new PrivKey().fromBn(new Bn(3))
    //     var keyPair3 = new KeyPair().fromPrivKey(privKey3)
    //     var addr3 = new Address().fromPubKey(keyPair3.pubKey)

    //     var privKey4 = new PrivKey().fromBn(new Bn(4))
    //     var keyPair4 = new KeyPair().fromPrivKey(privKey4)
    //     var addr4 = new Address().fromPubKey(keyPair4.pubKey)

    //     var privKey5 = new PrivKey().fromBn(new Bn(5))
    //     var keyPair5 = new KeyPair().fromPrivKey(privKey5)
    //     var addr5 = new Address().fromPubKey(keyPair5.pubKey)

    //     var privKey6 = new PrivKey().fromBn(new Bn(6))
    //     var keyPair6 = new KeyPair().fromPrivKey(privKey6)
    //     var addr6 = new Address().fromPubKey(keyPair6.pubKey)

    //     var privKey7 = new PrivKey().fromBn(new Bn(7))
    //     var keyPair7 = new KeyPair().fromPrivKey(privKey7)
    //     var addr7 = new Address().fromPubKey(keyPair7.pubKey)

    //     var privKey8 = new PrivKey().fromBn(new Bn(8))
    //     var keyPair8 = new KeyPair().fromPrivKey(privKey8)
    //     var addr8 = new Address().fromPubKey(keyPair8.pubKey)

    //     var privKey9 = new PrivKey().fromBn(new Bn(9))
    //     var keyPair9 = new KeyPair().fromPrivKey(privKey9)
    //     var addr9 = new Address().fromPubKey(keyPair9.pubKey)

    //     var privKey10 = new PrivKey().fromBn(new Bn(10))
    //     var keyPair10 = new KeyPair().fromPrivKey(privKey10)
    //     var addr10 = new Address().fromPubKey(keyPair10.pubKey)

    //     var privKey11 = new PrivKey().fromBn(new Bn(11))
    //     var keyPair11 = new KeyPair().fromPrivKey(privKey11)
    //     var addr11 = new Address().fromPubKey(keyPair11.pubKey)

    //     // txOuts that we are spending
    //     var scriptout1 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr1.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout2 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr2.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout3 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr3.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout4 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr4.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout5 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr5.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout6 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr6.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout7 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr7.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout8 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr8.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout9 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr9.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout10 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr10.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')
    //     var scriptout11 = new Script().fromString('OP_DUP OP_HASH160 20 0x' + addr11.hashBuf.toString('hex') + ' OP_EQUALVERIFY OP_CHECKSIG')

    //     var txOut1 = TxOut.fromProperties(new Bn(1e8), scriptout1)
    //     var txOut2 = TxOut.fromProperties(new Bn(1e8), scriptout2)
    //     var txOut3 = TxOut.fromProperties(new Bn(1e8), scriptout3)
    //     var txOut4 = TxOut.fromProperties(new Bn(1e8), scriptout4)
    //     var txOut5 = TxOut.fromProperties(new Bn(1e8), scriptout5)
    //     var txOut6 = TxOut.fromProperties(new Bn(1e8), scriptout6)
    //     var txOut7 = TxOut.fromProperties(new Bn(1e8), scriptout7)
    //     var txOut8 = TxOut.fromProperties(new Bn(1e8), scriptout8)
    //     var txOut9 = TxOut.fromProperties(new Bn(1e8), scriptout9)
    //     var txOut10 = TxOut.fromProperties(new Bn(1e8), scriptout10)
    //     var txOut11 = TxOut.fromProperties(new Bn(1e8), scriptout11)
    //     // total balance: 11e8
    ...
    //   test('should be able to add more inputs to pay the fee',  () {
    //     // make change address
    //     var privKey = new PrivKey().fromBn(new Bn(100))
    //     var keyPair = new KeyPair().fromPrivKey(privKey)
    //     var changeaddr = new Address().fromPubKey(keyPair.pubKey)
    ...
    //   test('should sign and verify a large number of inputs and outputs with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 50
    //     var nOuts = 50
    ...
    //   test('should sign and verify a large number of inputs and outputs, with incrementing amounts, with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 50
    //     var nOuts = 30
    ...
    //   test('should sign and verify a large number of inputs and outputs, with the same key, with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 50
    //     var nOuts = 30
    ...
    //   test('should sign and verify a large number of inputs and outputs, with BIP 69 sorting, with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 50
    //     var nOuts = 30
    ...
    //   test('should sign and verify a large number of inputs and outputs, with BIP 69 sorting with incrementing amounts, with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 50
    //     var nOuts = 30
    ...
    //   test('should sign and verify a large number of inputs and outputs, with BIP 69 sorting with decrementing amounts, with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 50
    //     var nOuts = 30
    ...
    //   test('should sign and verify with one output if change is less than dust with dropping change with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 3
    //     var nOuts = 1
    ...
    //   test('should sign and verify a large number of inputs and outputs, with very small amounts for inputs (1000 satoshis), with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 100
    //     var nOuts = 1
    ...
    //   test('should sign and verify a large number of inputs and outputs, with very small amounts for inputs (1000 satoshis, 0.01 sat/byte fee), with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 100
    //     var nOuts = 1
    ...
    //   test('should sign and verify a large number of inputs and outputs, with very small amounts for inputs (1499 satoshis, 0.01 sat/byte fee), with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 100
    //     var nOuts = 1
    ...
    //   test('should sign and verify a large number of inputs and outputs, with very small amounts for inputs (1499 satoshis, 0.5 sat/byte fee), with converting to/from JSON',  () {
    //     this.timeout(10000)
    //     var nIns = 100
    //     var nOuts = 1
    ...
    //     var txVerifier = new TxVerifier(txb.tx, txb.uTxOutMap)
    ...
    //     //   var verified = txVerifier.verifyNIn(nIn, Interp.SCRIPT_ENABLE_SIGHASH_FORKID)
    ...
    //     var txVerifier2 = new TxVerifier(txb2.tx, txb2.uTxOutMap)
